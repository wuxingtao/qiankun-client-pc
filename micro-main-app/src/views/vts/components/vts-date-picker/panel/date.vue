        ...
        <div class="el-picker-panel__body">
          <div class="el-date-picker__time-header"
            ...
            <span class="el-date-picker__editor-wrap">
              <el-input :placeholder="t('el.datepicker.selectDate')"
                        :value="visibleDate"
                        size="small"
...
<script type="text/babel">
  ...
  export default {
    ...
    watch: {
      ...
      value (val) {
        ...
        if (isDate(val)) {
          ...
          this.date = this.minDate ? new Date(this.minDate) : this.getDefaultValue()
        }
      },
    ...
    methods: {
      ...
      emit (value, ...args) {
        if (this.minDate && compareDateSizes(this.minDate, value)) {
          value = new Date(this.minDate)
        } else if (this.maxDate && compareDateSizes(value, this.maxDate)) {
      ...
      visibleTime () {
        if (this.userInputTime !== null) {
          ...
          if (this.minDate && this.value) {
            if (compareDateSizes(this.minDate, this.value)) {
