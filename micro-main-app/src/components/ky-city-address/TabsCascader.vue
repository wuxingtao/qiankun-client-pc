<template>
  <el-popover placement="bottom-start" :width="width" :popper-options="{boundariesElement:'body'}" trigger="manual" v-model="visible" popper-class="popover-tabs-cascader" @hide="popoverVisible=false" @show="popoverVisible=true">
...
export default {
  ...
  props: {
    value: { type: String },
    placeholder: { type: String, default: "请选择市" },
